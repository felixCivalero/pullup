    ...
    >
      <div
        style={{
          ...
          borderRadius: 24,
          background: "#ffffff",
          boxShadow: "0 24px 60px rgba(10,10,10,0.14), 0 0 0 1px " + colors.border,
      ...
      >
        <button
          ...
          style={{
            ...
            color: colors.textSubtle, cursor: "pointer", padding: 4,
          }}
        >
          <X size={20} />
        </button>
        ...
        {showAuthStep && (
          <>
            <h2 style={{ fontSize: 22, fontWeight: 800, marginBottom: 4, textAlign: "center", color: colors.text }}>
              Publish on{" "}
              <span style={{ color: colors.accent }}>
                pullup
              </span>
            </h2>
            <p style={{ fontSize: 13, color: colors.textSubtle, textAlign: "center", marginBottom: 24 }}>
            ...
            <form onSubmit={handleEmailPasswordSubmit} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                <label style={{ fontSize: 12, color: colors.textMuted }} htmlFor="publish-auth-email">Email</label>
                <input
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                <label style={{ fontSize: 12, color: colors.textMuted }} htmlFor="publish-auth-password">Password</label>
                <input
              ...
              <label style={{
                ...
                <input
                  ...
                  style={{ accentColor: colors.accent, flexShrink: 0, width: 18, height: 18 }}
                />
                <span>
                  I agree to the{" "}
                  <a href="/terms" target="_blank" rel="noopener noreferrer" onClick={(e) => e.stopPropagation()} style={{ color: colors.accent, textDecoration: "underline" }}>terms</a>
                  {" "}and{" "}
                  <a href="/privacy" target="_blank" rel="noopener noreferrer" onClick={(e) => e.stopPropagation()} style={{ color: colors.accent, textDecoration: "underline" }}>privacy policy</a>
                </span>
              </label>
              <button
              ...
              {formError && (
                <div style={{ fontSize: 12, color: colors.danger, textAlign: "center" }}>
                  {formError}
                </div>
              )}
              <div style={{ display: "flex", alignItems: "center", gap: 12, margin: "4px 0" }}>
                <div style={{ flex: 1, height: 1, background: colors.border }} />
                <span style={{ fontSize: 11, textTransform: "uppercase", letterSpacing: "0.16em", color: colors.textSubtle }}>or</span>
                <div style={{ flex: 1, height: 1, background: colors.border }} />
              </div>
              <button
