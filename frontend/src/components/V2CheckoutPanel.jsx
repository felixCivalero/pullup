...
const RAIL_META = {
  ...
  swish: { label: "Swish", hint: "Opens the Swish app" },
    ...
    return (
      <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
        ...
        <div style={noticeStyle("rgba(255,255,255,0.04)", "rgba(255,255,255,0.1)")}>
          ...
          {ins.type === "swish_mcommerce" && ins.appUrl && (
            <a
              href={ins.appUrl}
        ...
        <button
          type="button"
          onClick={() => { clearInterval(pollRef.current); setCharge(null); setStatus(null); }}
