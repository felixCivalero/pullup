...
import { Users, MapPin, Calendar, ChevronDown, ChevronUp, ExternalLink } from "lucide-react";
import { DateRangePicker } from "../components/DateRangePicker.jsx";
import {
  SectionLabel, StatPill, RateBar, ChangeIndicator,
...
export function AnalyticsPage() {
  ...
  // Three views: the Landing overview (default — how the front door is
  // doing), platform-wide PullUp analytics, or a list of every event that
  // opens the same per-event analytics page the host sees.
